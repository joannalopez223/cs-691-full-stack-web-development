defmodule EctoWorksheet.AccountsTest do
  use EctoWorksheet.DataCase

  alias EctoWorksheet.Accounts

  describe "users" do
    alias EctoWorksheet.Accounts.User

    import EctoWorksheet.AccountsFixtures
